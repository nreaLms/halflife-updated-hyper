...
void CHud::Init()
{
	...
	cl_bob_head = CVAR_CREATE("cl_bob_head", "0", FCVAR_ARCHIVE);
	...
	cl_viewmodel_sway = CVAR_CREATE("cl_viewmodel_sway", "0", FCVAR_ARCHIVE);
	cl_cam_jumpland = CVAR_CREATE("cl_cam_jumpland", "0", FCVAR_ARCHIVE);
